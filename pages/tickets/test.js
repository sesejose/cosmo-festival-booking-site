        ...
        <div className="container-page">
          <Box>
            ...
            <MobileStepper
              ...
              position="static"
              nextButton={
                <Button className="btn-turquoise" onClick={handleNext} disabled={activeStep === maxSteps - 1}>
                  Next
                  {theme.direction === "rtl" ? <KeyboardArrowLeft /> : <KeyboardArrowRight />}
                </Button>
              }
              backButton={
                <Button className="btn-turquoise" onClick={handleBack} disabled={activeStep === 0}>
